...
\usepackage{lmodern}
\usepackage{amsmath}
\usepackage{textcomp} % Pour le symbole Euro

\title{Exercices Corrigés - Instruction du contentieux des taxes foncières}
\author{Formation de base - Fillière Cadastre}
\date{Avril 2026}
