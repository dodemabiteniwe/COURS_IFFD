...
\begin{itemize}
	...
	\item \textbf{Exonérations temporaires(Le piège déclaratif) :} C'est le contentieux le plus fréquent. Il porte sur la date d'achèvement des travaux ou sur le non-respect du délai de déclaration (04 mois après l'achèvement).\\
...
La qualification du dossier détermine le régime juridique applicable, résumé dans le tableau \ref{tab:comp_proc_foncier} comparatif ci-dessous :
